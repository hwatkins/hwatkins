...
📄 **[ex_guten](https://github.com/hwatkins/ex_guten)** — Typographic-quality PDF generation for Elixir, a modern port of Joe Armstrong's erlguten. Published on [Hex.pm](https://hex.pm/packages/ex_guten).
